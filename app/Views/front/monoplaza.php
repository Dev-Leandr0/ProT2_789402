...
<section class="monoplaza-partes">
    ...
    <section class="seccion-sobre-nosotros position-relative overflow-hidden text-white">
      ...
      <div class="container">
        ...
        <div class="grid-neumaticos">
          ...
          <div class="neumatico">
            <img src="assets/img/neumaticos/blanco.png" alt="Neumático blando">
            <div class="contenido-neumatico">
              <h3>Blando (Soft - C5)</h3>
              <p>Mayor adherencia, ideal para clasificación o condiciones frías. Se desgasta rápidamente. Red Bull lo
                utiliza para ganar ventaja en clasificación y las primeras vueltas en carrera.</p>
              <hr>
            </div>
          </div>
          ...
          <div class="neumatico">
            ...
            <div class="contenido-neumatico">
              ...
              <p>Equilibrio entre rendimiento y durabilidad. Muy usado durante la carrera. El compuesto más versátil,
                clave en la estrategia de carrera de Red Bull.</p>
              <hr>
            </div>
          </div>

          <div class="neumatico">
            <img src="assets/img/neumaticos/rojo.png" alt="Neumático duro">
            <div class="contenido-neumatico">
              <h3>Duro (Hard - C1)</h3>
              <p>Más duradero pero con menor agarre. Ideal para stints largos. Red Bull lo emplea cuando busca minimizar
                paradas y mantener ritmo constante.</p>
              <hr>
            </div>
          </div>
          ...
          <div class="neumatico">
            ...
            <div class="contenido-neumatico">
              <h3>Intermedio</h3>
              <p>Usado cuando la pista está mojada pero no completamente encharcada. Perfecto para condiciones
                cambiantes.
                Max Verstappen lo domina bien en lluvia ligera.</p>
              <hr>
            </div>
          </div>
          ...
          <div class="neumatico">
            ...
            <div class="contenido-neumatico">
              ...
              <p>Canales profundos para evacuar agua. Usado en lluvia intensa. Su uso es limitado, pero esencial para
                carreras con alta precipitación.
                <hr>
            </div>
          </div>
        </div>
